...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            <a class="nav-link" href="{{URL::to('/users')}}">Quản lý người dùng</a>
            <a class="nav-link" href="{{URL::to('/product')}}">Quản lý sản phẩm</a>
            <a class="nav-link active" href="{{URL::to('/category')}}">Quản lý danh mục</a>
            <a class="nav-link" href="{{URL::to('/discount')}}">Quản lý giảm giá</a>
        </nav>
    </div>
