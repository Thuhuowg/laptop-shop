            ...
            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 mt-5">
                <form id="login-form" class="form-container">
                    ...
                    <div class="text-center text-lg-start">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">Chưa có tài khoản? <a href="{{ route('register') }}" class="link-danger">Đăng ký</a></p>
                    </div>
    ...
    document.getElementById('login-button').addEventListener('click', async function (event) {
        ...
        try {
            ...
            if (data.token) {
                ...
                const redirectUrl = data.user.role_id === 2 ? '/fe/product/product.html' : '/users';
